function PrintUMTbyDate()
	...
	***Jangan di ubah!!!*****************************************
	...
	/////cEmployeeCode:='13.05.1711' //aDataCell[3]
	/////cEmployeeName:='TIKA KARTIKA' //aDataCell[4]
	cPosition:='XXCDEFGHIJABCDEFGHIJABCDEFGHXX'  //aDataCell[5]
	
	cJML_HR_GK:=22 //aDataCell[6]
	cJML_HR_UM:=22 //aDataCell[7]
	cJML_HR_UT:=22 //aDataCell[8]
	
	cJML_POT_UM:=3 //aDataCell[9]	  
	cJML_POT_UT:=3 //aDataCell[10]
	
	cTUN_UM:=10500 //aDataCell[11]
	cTUN_UT:=13300 //aDataCell[12]
	cRpUangMakan:=(cJML_HR_UM-cJML_POT_UM)*cTUN_UM  //aDataCell[13]
	cRpUangTransport:=(cJML_HR_UT-cJML_POT_UT)*cTUN_UT //aDataCell[14]
	cRpTotalDiterima:=cRpUangMakan+cRpUangTransport //aDataCell[15]
    cTotalAbsDeductionSalary:=1 //aDataCell[16]
    cRemark:='A-(9/9);' //DataCell[17]
	...
	*-------------
	...
	@ 29,122 print RECTANGLE TO 33,131 penwidth 0.1 COLOR {224,224,224} FILLED
	@ 29, 125 PRINT "UM" FONT "Arial" SIZE 6 COLOR BLACK
	
	@ 29,131 print RECTANGLE TO 33,140 penwidth 0.1 COLOR {224,224,224} FILLED
	@ 29, 134 PRINT "UT" FONT "Arial" SIZE 6 COLOR BLACK
	...
	*------------
	...
	@ 29,140 print RECTANGLE TO 33,149 penwidth 0.1 COLOR {224,224,224} FILLED
	@ 29, 143 PRINT "UM" FONT "Arial" SIZE 6 COLOR BLACK
	
	@ 29,149 print RECTANGLE TO 33,158 penwidth 0.1 COLOR {224,224,224} FILLED
	@ 29, 152 PRINT "UT" FONT "Arial" SIZE 6 COLOR BLACK
	
	*------------
	
	@ 25,158 print RECTANGLE TO 29,186 penwidth 0.1 COLOR {224,224,224} FILLED
	@ 26,168 PRINT "RINCIAN" FONT "Arial" SIZE 6 COLOR BLACK
	
	@ 29,158 print RECTANGLE TO 33,172 penwidth 0.1 COLOR {224,224,224} FILLED
	@ 29, 164 PRINT "UM" FONT "Arial" SIZE 6 COLOR BLACK
	
	@ 29,172 print RECTANGLE TO 33,186 penwidth 0.1 COLOR {224,224,224} FILLED
	@ 29,177  PRINT "UT" FONT "Arial" SIZE 6 COLOR BLACK
